...
if database:sismember(bot_id.."Revor:Chek:Groups",chat_id) then
Status = true
else 
Status = false
end
...
if database:sismember(bot_id.."Revor:Muted:User"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if database:sismember(bot_id.."Revor:Ban:User"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if database:sismember(bot_id.."Revor:GBan:User",User_id) then
Status = true
else
Status = false
end
...
database:sadd(bot_id..'Revor:Chek:Groups',idg) 
database:set(bot_id.."Revor:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Revor:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."Revor:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."Revor:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."Revor:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."Revor:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
...
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function Revor_Files(msg)
for v in io.popen('ls Revor_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Revor_Files/"..v)
if plugin.Revor and msg then
pre_msg = plugin.Revor(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function Revor_Started_Bot(msg,data) -- بداية العمل
if msg then
...
if id:match("-100(%d+)") then
database:incr(bot_id..'Revor:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'Revor:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."Revor:Revor:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."Revor:Revor:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Revor:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'Revor:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'Revor:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'Revor:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'Revor:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."Revor:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."Revor:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Revor:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."Revor:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."Revor:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."Revor:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Revor:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Revor:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Revor:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."Revor:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Revor:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."Revor:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."Revor:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."Revor:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."Revor:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."Revor:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."Revor:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."Revor:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."Revor:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."Revor:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."Revor:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."Revor:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Revor:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"• تم الغاء وضع الوصف") 
database:del(bot_id.."Revor:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Revor:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Revor:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ الترحيب") 
database:del(bot_id.."Revor:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Revor:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."Revor:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"• تم حفظ ترحيب المجموعة")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Revor:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"• تم الغاء حفظ الرابط")       
database:del(bot_id.."Revor:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
...
if database:get(bot_id.."Revor:Revor:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه للخاص") 
database:del(bot_id.."Revor:Revor:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'Revor:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."Revor:Revor:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."Revor:Revor:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Revor:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."Revor:Revor:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."Revor:Revor:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."Revor:Revor:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء الاذاعه") 
database:del(bot_id.."Revor:Revor:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."Revor:UsersBot")   
...
local Revor_Msg = database:sismember(bot_id.."Revor:List:Filter:text"..msg.chat_id_,text) 
if Revor_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."Revor:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."Revor:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."Revor:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
if database:get(bot_id.."Revor:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء•" then   
send(msg.chat_id_, msg.id_,"• تم الغاء حفظ اسم البوت") 
database:del(bot_id.."Revor:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Revor:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."Revor:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "• تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."Revor:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."Revor:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• ارسل الامر الجديد")  
database:del(bot_id.."Revor:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."Revor:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."Revor:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."Revor:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"• تم حفظ الامر")  
database:del(bot_id.."Revor:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."Revor:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."Revor:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Revor:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Revor:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."Revor:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."Revor:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."Revor:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."Revor:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."Revor:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Revor:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."Revor:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."Revor:lockpin"..msg.chat_id_)  
database:srem(bot_id.."Revor:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."Revor:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."Revor:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'Revor:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."Revor:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."Revor:Lock:Sticker"..msg.chat_id_)  
...
database:hset(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"flood")  
...
function Function_Revor(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Revor, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Revor, nil)
return false 
end
...
if text == ("الثانويين") and DevRevor(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n• قائمة مطورين الثانويين للبوت \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("مسح قائمة العام") and DevRevor(msg) then
database:del(bot_id.."Revor:GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمة العام")
return false
end
if text == ("مسح المطورين") and DevRevor(msg) then
database:del(bot_id.."Revor:Sudo:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."Revor:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."Revor:Constructor"..msg.chat_id_)
...
database:del(bot_id.."Revor:Manager"..msg.chat_id_)
...
database:del(bot_id.."Revor:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."Revor:Special:User"..msg.chat_id_)
...
database:del(bot_id.."Revor:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."Revor:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n• تم مسح المحظورين")
end
if text == ("قائمة العام") and DevRevor(msg) then
local list = database:smembers(bot_id.."Revor:GBan:User")
t = "\n• قائمة المحظورين عام \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
if text == ("المطورين") and DevRevor(msg) then
local list = database:smembers(bot_id.."Revor:Sudo:User")
t = "\n• قائمة مطورين البوت \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Revor:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Revor:Constructor"..msg.chat_id_)
t = "\n• قائمة المنشئين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Revor:Manager"..msg.chat_id_)
t = "\n• قائمة المدراء \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Revor:Mod:User"..msg.chat_id_)
t = "\n• قائمة الادامن \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Revor:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Revor:Muted:User"..msg.chat_id_)
t = "\n• قائمة المكتومين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Revor:Ban:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRevor(msg) then
function Function_Revor(extra, result, success)
...
database:sadd(bot_id.."Revor:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevRevor(msg) then
...
database:sadd(bot_id.."Revor:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevRevor(msg) then
...
database:sadd(bot_id.."Revor:GBan:User", userid)
Reply_Status(msg,userid,"reply","• تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRevor(msg) then
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Revor, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevRevor(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_Revor(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","• تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."Revor:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"• لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevRevor(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."Revor:GBan:User", userid)
Reply_Status(msg,userid,"reply","• تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRevor(msg) then
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Revor, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevRevor(msg) then
...
database:sadd(bot_id.."Revor:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevRevor(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Revor:Sudo:User", userid)
Reply_Status(msg,userid,"reply","• تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevRevor(msg) then
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Revor, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevRevor(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevRevor(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."Revor:Sudo:User", userid)
...
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Constructor"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","• تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Revor, nil)
end
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","• تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"• لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."Revor:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","• تم تنزيله من المنشئين")  
end
...
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Manager"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:Manager"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Mod:User"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Special:User"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."Revor:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Revorrt = database:get(bot_id.."Revor:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Revorrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "yousef_labban")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Revor:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Revorrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "yousef_labban")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Revor:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Revorrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "yousef_labban")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Revor:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif Revorrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "yousef_labban")..")".."\n• تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif Revorrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "yousef_labban")..")".."\n• تم تنزيله من "..RTPA.." هنا\n")  
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."Revor:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local Revorrt = database:get(bot_id.."Revor:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Revorrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "yousef_labban")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Revor:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif Revorrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "yousef_labban")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Revor:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif Revorrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "yousef_labban")..")".."\n• تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Revor:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."Revor:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."Revor:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."Revor:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:Muted:User"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'Revor:Revor:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'Revor:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'Revor:Revor:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'Revor:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","• تم قفـل الفشار")  
end
if text and database:get(bot_id..'Revor:Revor:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'Revor:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'Revor')..') '
...
if database:sismember(bot_id.."Revor:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."Revor:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."Revor:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"• انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"• ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."Revor:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:sadd(bot_id.."Revor:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."Revor:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "• تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."Revor:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."Revor:allM"..msg.chat_id_)
...
database:set(bot_id.."Revor:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."Revor:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."Revor:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."Revor:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."Revor:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."Revor:Chek:Welcome"..msg.chat_id_,true) 
...
database:del(bot_id.."Revor:Chek:Welcome"..msg.chat_id_) 
...
if Addictive(msg) then
database:del(bot_id.."Revor:Get:Welcome:Group"..msg.chat_id_) 
...
database:set(bot_id.."Revor:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."Revor:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."Revor:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."Revor:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Revor:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."Revor:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Revor:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."Revor:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Revor:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"• تم منع الكلمه بنجاح")  
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Revor:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Revor:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Revor:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."Revor:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:set(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منعها ")  
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Revor:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع المتحركة بنجاح ")  
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Revor:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Revor:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"• تم الغاء منع الصورة بنجاح ")  
database:del(bot_id.."Revor:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."Revor:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."Revor:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "• تم الغاء حفظ القوانين") 
database:del(bot_id.."Revor:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Revor:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."Revor:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."Revor:Set:Rules:Group"..msg.chat_id_) 
end
end
...
local Set_Rules = database:get(bot_id.."Revor:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_.."")
t = "• قائمة الاوامر المضافه  \n  ━═━═━═━\n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"• تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "ترتيب الاوامر" and Constructor(msg) then
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصورة")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصورة")
database:sadd(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
database:set(bot_id.."Revor:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
if Constructor(msg) then
database:set(bot_id.."Revor:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_Revor(extra, result, success)
database:sadd(bot_id.."Revor:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Revor:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Revor:MN:TF"..msg.chat_id_, userid)
...
function Function_Revor(extra, result, success)
database:srem(bot_id.."Revor:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_Revor(extra, result, success)
if result.id_ then
database:srem(bot_id.."Revor:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Revor:MN:TF"..msg.chat_id_, userid)
...
local list = database:smembers(bot_id.."Revor:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
Status = database:get(bot_id.."Revor:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
database:del(bot_id.."Revor:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Revor:MN:TF"..msg.chat_id_)
t = "\n• قائمة المنظفين \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Revor:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Revor:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."Revor:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."Revor:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."Revor:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."Revor:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."Revor:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "• تم مسح الصلاحيه ") 
end
if database:get(bot_id.."Revor:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"• تم الغاء الامر ") 
database:del(bot_id.."Revor:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."Revor:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."Revor:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."Revor:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المطور الى ↺ "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."Revor:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المنشئ الاساسي الى ↺ "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."Revor:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المنشئ الى ↺ "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."Revor:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"• تم تغير رد المدير الى ↺ "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."Revor:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد الادمن الى ↺ "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."Revor:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد المميز الى ↺ "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."Revor:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"• تم تغير رد العضو الى ↺ "..Teext)
end


if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."Revor:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."Revor:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."Revor:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."Revor:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."Revor:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."Revor:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."Revor:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."Revor:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."Revor:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."Revor:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."Revor:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركة 🎭"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق•"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رسالة ✉"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صورة•"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف•"
elseif database:get(bot_id.."Revor:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") ↺ {"..db.."}\n"
end
...
local test = database:get(bot_id.."Revor:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Revor:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Revor:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Revor:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Revor:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Revor:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Revor:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Revor:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."Revor:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '• الان ارسل الرد الذي تريد اضافته \n• قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركة )\n• يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."Revor:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."Revor:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Revor:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Revor:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Revor:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."Revor:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."Revor:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."Revor:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."Revor:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."Revor:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."Revor:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."Revor:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Revor:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."Revor:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'Revor:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Revor:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."Revor:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."Revor:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."Revor:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."Revor:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."Revor:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."Revor:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."Revor:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'Revor:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'Revor:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
database:sadd(bot_id.."Revor:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevRevor(msg) then 
local list = database:smembers(bot_id.."Revor:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."Revor:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."Revor:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."Revor:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."Revor:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."Revor:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."Revor:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."Revor:Add:Rd:Sudo:File"..v)
database:del(bot_id.."Revor:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."Revor:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"• تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevRevor(msg) then 
local list = database:smembers(bot_id.."Revor:List:Rd:Sudo")
text = "\n• قائمة ردود المطور \n  ━═━═━═━\n"
for k,v in pairs(list) do
if database:get(bot_id.."Revor:Add:Rd:Sudo:Gif"..v) then
db = "متحركة 🎭"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:stekr"..v) then
db = "ملصق•"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:Text"..v) then
db = "رسالة ✉"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:Photo"..v) then
db = "صورة•"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:File"..v) then
db = "ملف•"
elseif database:get(bot_id.."Revor:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") ↺ {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."Revor:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Revor:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Revor:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Revor:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Revor:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Revor:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Revor:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Revor:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."Revor:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"• تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevRevor(msg) then 
send(msg.chat_id_, msg.id_,"• ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevRevor(msg) then 
send(msg.chat_id_, msg.id_,"• ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."Revor:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '• الان ارسل الرد الذي تريد اضافته \n• قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركة )\n• يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."Revor:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."Revor:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Revor:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"• تم ازالة الرد من قائمة ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'Revor:'..v..text)
end
database:del(bot_id.."Revor:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Revor:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."Revor:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'Revor:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Revor:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."Revor:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."Revor:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."Revor:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."Revor:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."Revor:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."Revor:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."Revor:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."Revor:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."Revor:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."Revor:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Revor:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Revor:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Revor:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Revor:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."Revor:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."Revor:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."Revor:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."Revor:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."Revor:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."Revor:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."Revor:User:Name"..v.user_id_) then
t = t.."•┆"..x.."︙[@"..database:get(bot_id.."Revor:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if not database:get(bot_id.."Revor:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."Revor:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."Revor:Kick:Me"..msg.chat_id_,true)  
Text = "\n• تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_Revor(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."Revor:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Revor:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Revor:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_Revor(extra, result, success)
if database:sismember(bot_id.."Revor:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Revor:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Revor:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."Revor:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."Revor:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
database:sadd(bot_id.."Revor:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."Revor:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"• تم مغادرة المجموعة") 
database:srem(bot_id.."Revor:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."Revor:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevRevor(msg) then   
database:del(bot_id.."Revor:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"• تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevRevor(msg) then  
database:set(bot_id.."Revor:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "• تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."Revor:Name:Bot") or "يوسف لبان") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Revor:Name:Bot") or "يوسف لبان")
local namebot = {
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
database:set(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Revor:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Revor:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Revor:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Revor:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Revor:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Revor:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Revor:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Revor:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and DevRevor(msg) then
 
local list = database:smembers(bot_id.."botss:Revor:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Revor:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Revor:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Revor:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Revor:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"تم حذف ردود المتعدده")
end
if text == ("الردود المتعدده") and DevRevor(msg) then
...
if text == "اضف رد متعدد" and DevRevor(msg) then
 
database:set(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DevRevor(msg) then
 
database:set(bot_id.."botss:Revor:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Revor:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Revor:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Revor:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Revor:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Revor:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Revor:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Revor:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Revor:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Revor:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Revor:Add:Rd:Sudo:Text2"..text)   
...
if DevRevor(msg) then
database:setex(bot_id.."Revor:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."Revor:Status:Bc") and not DevRevor(msg) then 
send(msg.chat_id_, msg.id_,"• الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."Revor:Revor:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Revor:Revor:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي سواء ~ { ملصق, متحركة, صورة, رسالة }\n• للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."Revor:Revor:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي سواء ~ { ملصق, متحركة, صورة, رسالة }\n• للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."Revor:Revor:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Revor:Revor:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevRevor(msg) then  
database:del(bot_id.."Revor:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n• تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevRevor(msg) then  
database:set(bot_id.."Revor:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n• تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."Revor:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."Revor:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."Revor:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."Revor:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."Revor:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."Revor:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."Revor:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."Revor:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."Revor:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."Revor:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."Revor:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."Revor:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n• ااعدادات المجموعة "..
"\n  ━═━═━═━"..
"\n• علامة ال {✓} تعني مفعل"..
...
database:set(bot_id.."Revor:Fun_Bots"..msg.chat_id_,"true")
end
...
database:del(bot_id.."Revor:Fun_Bots"..msg.chat_id_)
end
...
database:del(bot_id..'Revor:Lock:ID:Bot'..msg.chat_id_) 
...
database:set(bot_id..'Revor:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:del(bot_id..'Revor:Lock:ID:Bot:Photo'..msg.chat_id_) 
...
database:set(bot_id..'Revor:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
database:setex(bot_id.."Revor:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
• ارسل الان النص
• يمكنك اضافه :
- `#username` > اسم المستخدم
...
database:set(bot_id.."Revor:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,'• تم تغير الايدي ارسل ايدي لرؤيته')
end
if text == 'حذف الايدي' or text == 'مسح الايدي' then
if Owner(msg) then
database:del(bot_id.."Revor:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '• تم ازالة رسالة الايدي ')
end
return false  
end 

if database:get(bot_id.."Revor:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"• تم الغاء تعين الايدي") 
database:del(bot_id.."Revor:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Revor:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."Revor:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'• تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'Revor:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Add_Mem = database:get(bot_id.."Revor:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."Revor:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'Revor:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'Revor:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'Revor:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end


if text == 'ايدي' and tonumber(msg.reply_to_message_id_) > 0 and not database:get(bot_id..'Revor:Lock:ID:Bot'..msg.chat_id_) or text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and not database:get(bot_id..'Revor:Lock:ID:Bot'..msg.chat_id_) then
function Function_Revor(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.first_name_ == false then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'Revor:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Revor:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."Revor:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'Revor:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'Revor:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '• عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'Revor:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '• تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعديلاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'Revor:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '• عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'Revor:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '• تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."Revor:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '• عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'Revor:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."Revor:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."Revor:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."Revor:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevRevor(msg) then
local pv = database:smembers(bot_id..'Revor:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'Revor:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف القروبات" and DevRevor(msg) then
local group = database:smembers(bot_id..'Revor:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'Revor:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevRevor(msg) then  
send(msg.chat_id_,msg.id_,'• تم التحديث')
os.execute('rm -rf Revor.lua')
os.execute('rm -rf Run')
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/Revor/master/Revor.lua')
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/Revor/master/Run')
dofile('Revor.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."Revor:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."Revor:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."Revor:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Revor:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."Revor:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."Revor:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Revor:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."Revor:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."Revor:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Revor:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الانستا')
database:set(bot_id.."Revor:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Revor:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Revor:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الافلام')
database:set(bot_id.."Revor:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."Revor:movie_bot"..msg.chat_id_) == "open" then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Revor Team .',url="t.me/yousef_labban "}},
}
local msg_id = msg.id_/2097152/0.5
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."Revor:Lock:Xn"..msg.chat_id_)=="del" then      
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."Revor:Lock:Xn"..msg.chat_id_)=="del" then
photo_id = msg.content_.photo_.sizes_[1].photo_.persistent_id_  
Srrt = https.request('https://Revor-source.tk/yousef_labban/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'تفعيل البوت الخدمي' and DevRevor(msg) then  
database:del(bot_id..'Revor:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'• تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevRevor(msg) then  
database:set(bot_id..'Revor:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'• تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevRevor(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'Revor:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'• تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'Revor:Chek:Groups')  
local Users = database:scard(bot_id..'Revor:UsersBot')  
send(msg.chat_id_, msg.id_,'• احصائيات البوت \n\n• عدد المجموعات *~ '..Groups..'\n• عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevRevor(msg) then
local list = database:smembers(bot_id..'Revor:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'Revor Chat'
ASAS = database:smembers(bot_id.."Revor:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."Revor:Constructor"..v)
MDER = database:smembers(bot_id.."Revor:Manager"..v)
MOD = database:smembers(bot_id.."Revor:Mod:User"..v)
link = database:get(bot_id.."Revor:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"Revor":"'..NAME..'",'
else
t = t..',"'..v..'":{"Revor":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'Revor:Text_Dev')
if Text_Dev then 
...
if text == 'نقل الاحصائيات' and DevRevor(msg) then
local Users = database:smembers('Revor:'..bot_id.."userss")
local Groups = database:smembers('Revor:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'Revor:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'Revor:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'• تم نقل : '..#Groups..' قروب\n• تم نقل : '..#Users..' مشترك \n• من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف رسالة المطور' and DevRevor(msg) then
database:del(bot_id..'Revor:Text_Dev')
send(msg.chat_id_, msg.id_,'• تم حذف رسالة المطور')
end
if text == 'وضع رسالة المطور' and DevRevor(msg) then
database:set(bot_id..'Revor:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'• ارسل الرسالة الان')
return false
end
if text and database:get(bot_id..'Revor:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Revor:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'• تم الغاء حفظ رسالة المطور')
return false
end
database:set(bot_id..'Revor:Text_Dev',text)
database:del(bot_id..'Revor:Set:Text_Dev'..msg.chat_id_)
...
if text == 'رفع النسخه الاحتياطيه' and DevRevor(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevRevor(msg) then
dofile("Revor.lua")  
send(msg.chat_id_, msg.id_, "• تم التحديث")
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Revor:Num:Add:Bot') or 0) and not DevRevor(msg) then
send(msg.chat_id_, msg.id_,'• عدد اعضاء المجموعة اقل من *~ {'..(database:get(bot_id..'Revor:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Revor:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'• المجموعة مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','• تم تفعيل المجموعة ~ '..chat.title_..'')
database:sadd(bot_id..'Revor:Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'Revor:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'Revor:Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Reply_Status(msg,result.id_,'reply_Add','• تم تفعيل المجموعة ~ '..chat.title_..'')
database:sadd(bot_id..'Revor:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'Revor:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'Revor:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'Revor:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if text and text:match("^/start ph(.*)$") then
Sf = database:get(bot_id.."Revor:Filter:msg")
local list = database:smembers(bot_id.."Revor:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Revor:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."Revor:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."Revor:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevRevor(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Revor:Filter"..msg.sender_user_id_) then
...
if DevRevor(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^- تغير الاشتراك• .$") and DevRevor(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رسالة الاشتراك• .$") and DevRevor(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رسالة الاشتراك• ." and DevRevor(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "• تم مسح رسالة الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك• .$") and DevRevor(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '• حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري• ." and DevRevor(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري• ." and DevRevor(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "• تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري• ." and DevRevor(msg) then  
...
database:srem(bot_id..'Revor:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:set(bot_id.."Revor:Lock:text"..data.chat_id_,true) 
...
inline = {
{{text = '• Revor 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/yousef_labban'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Revor:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."Revor:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Revor:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."Revor:List:Filter:Sticker"..idchci,Sticker)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."Revor:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."Revor:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."Revor:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."Revor:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."Revor:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."Revor:List:Filter:Photo"..delallph,v)  
end  
end
end
...
if text and not database:sismember(bot_id..'Revor:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'Revor:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'Revor:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."Revor:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."Revor:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."Revor:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."Revor:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."Revor:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."Revor:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."Revor:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."Revor:Name:Bot") or "يوسف لبان")
if not database:get(bot_id.."Revor:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
Revor_Started_Bot(msg,data)
Revor_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'Revor:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."Revor:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."Revor:Basic:Constructor"..msg.chat_id_)
t = "• المنشئين الاساسين تعالو مخرب \n  ━═━═━═━\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Revor:User:Name" .. v)
...
if database:get(bot_id.."Revor:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."Revor:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."Revor:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."Revor:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local Revor_Msg = database:sismember(bot_id.."Revor:List:Filter:text"..result.chat_id_,text) 
if Revor_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."Revor:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."Revor:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."Revor:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'Revor:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'Revor:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'Revor:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'Revor:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Revor:Chek:Groups',v)  
end
...
database:sadd(bot_id..'Revor:Chek:Groups',v)  
end end,nil)
